...
public class TransactionsMapper {
	...
	public Transactions toPostgresObject(com.a2nine.accounts.domain.model.Transactions transactions) {
	...
	public com.a2nine.accounts.domain.model.Transactions toDomainObject(Transactions pgTransactions) {
		Set<com.a2nine.accounts.domain.model.LineItem> lineItems = this.lineItemMapper
		...
		double other = 0.0d;
		Set<com.a2nine.accounts.domain.model.LineItem> reOrganisedList = new HashSet<>();
		for (com.a2nine.accounts.domain.model.LineItem lt : lineItems) {
		...
		return new com.a2nine.accounts.domain.model.Transactions(pgTransactions.getId(),
	...
	public List<com.a2nine.accounts.domain.model.Transactions> toListOfDomainObjects(List<Transactions> pgTransactions,
			Set<LineItem> pgLineItems) {
		List<com.a2nine.accounts.domain.model.Transactions> transactions = new ArrayList<>();
