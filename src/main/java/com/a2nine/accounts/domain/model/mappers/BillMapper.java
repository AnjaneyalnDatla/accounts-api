...
public class BillMapper {
	...
	public com.a2nine.accounts.domain.model.postgres.Bill toPostgresObject(Bill aBill) {
		return new com.a2nine.accounts.domain.model.postgres.Bill(aBill.id(), aBill.transaction_number(), null,
	...
	public Bill toDomainObject(com.a2nine.accounts.domain.model.postgres.Bill pgBill) {
	...
	public Set<Bill> toListDomainObject(Set<com.a2nine.accounts.domain.model.postgres.Bill> pgBill) {
		if (pgBill == null)
			return null;
	...
	public Set<com.a2nine.accounts.domain.model.postgres.Bill> toListPostgresObject(Set<Bill> aList) {
		if (aList == null)
			return null;
