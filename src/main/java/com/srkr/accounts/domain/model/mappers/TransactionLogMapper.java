...
public class TransactionLogMapper {
	...
	public TransactionLog toPostgresObject(com.srkr.accounts.domain.model.TransactionLog transactionLog) {
	...
	public com.srkr.accounts.domain.model.TransactionLog toDomainObject(TransactionLog retPgTransactionLog) {
		// TODO Auto-generated method stub
		return new com.srkr.accounts.domain.model.TransactionLog(retPgTransactionLog.getId(),
