...
public class ContactsTest {
	...
	public void TestContacts() {
		Contacts contacts = new Contacts(new Long(123455), "supplemId", true, "AFS system", "Lara", "N", "Brain",
				"608-609-5525", "608-322-5525", "608-213-5525", "", "test@test.in", "water side ln", "Macomb", "MI",
				"USA", "01545", "Patel Bros", "No comments", "License", "WI-21129032", "Engineer", 2000.00,
