...
public class FindAndSaveContactsTest {
	...
	public void findAllContacts() {
		assertNotNull(findAndSaveContacts.findAllContacts("DEFAULT"));
	}

	@Test
	public void findContacts() {
		try {
			assertNotNull(findAndSaveContacts.findContacts("Lara", "Brain", "DEFAULT"));
	...
	public void findContactById() {
		assertNotNull(findAndSaveContacts.findContactById(id, "DEFAULT"));
	}
}
