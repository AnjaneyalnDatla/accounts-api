...
public class PostgresContactsRepositoryTest {
	...
	@Test
	public void findAll() {
		List<Contacts> contacts = contactsRepository.findByOrgcode("DEFAULT");
		assertNotNull(contacts);
	}

	@Test
	public void findAccountsByName() {
		List<Contacts> contacts = contactsRepository.findByFirstnameAndOrgcode("Lara", "DEFAULT");
		assertNotNull(contacts);
	}
	...
	public void findById() {
		Contacts contacts = contactsRepository.findByIdAndOrgcode(1l, "DEFAULT");
		assertNotNull(contacts);
	}
	/*
	 * @After public void after() { contactsDeleteList.forEach(contact -> {
